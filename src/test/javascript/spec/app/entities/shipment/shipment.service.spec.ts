    ...
    describe('Shipment Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/shipments';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Shipment', () => {
                service.create(new Shipment(null)).subscribe(received => {
            ...
            it('should update a Shipment', () => {
                service.update(new Shipment(123)).subscribe(received => {
