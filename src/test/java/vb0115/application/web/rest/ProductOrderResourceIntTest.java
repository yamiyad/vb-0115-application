...
import vb0115.application.repository.ProductOrderRepository;
import vb0115.application.service.ProductOrderService;
...
public class ProductOrderResourceIntTest {
    ...
    public void createProductOrder() throws Exception {
        ...
        assertThat(testProductOrder.getRemarks()).isEqualTo(DEFAULT_REMARKS);
    }
    ...
    public void updateProductOrder() throws Exception {
        ...
        assertThat(testProductOrder.getRemarks()).isEqualTo(UPDATED_REMARKS);
    }
