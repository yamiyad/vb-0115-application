...
export class ProductCategoryComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.productCategoryService
            ...
            .subscribe(
                (res: HttpResponse<IProductCategory[]>) => this.paginateProductCategories(res.body, res.headers),
    ...
    private paginateProductCategories(data: IProductCategory[], headers: HttpHeaders) {
